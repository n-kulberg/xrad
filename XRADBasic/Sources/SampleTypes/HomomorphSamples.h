...
/*!
	...
	Пример: шаблон, вычисляющий среднее от массива. Возможен массив short и complex_sample<short>.
	Тип результата, как и буфера накопления, должен быть double и complex_sample<double>.
